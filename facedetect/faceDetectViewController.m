...
- (CALayer *)makeFaceLayer {
    ...
    layer.contents = (id)[UIImage imageNamed:@"clone-trooper"].CGImage;
    //返回layer
    return layer;
}
...
- (CALayer *)overlayLayer {
    ...
    NSLog(@" return _overlayLayer");
    return _overlayLayer;
}
- (UIButton *)switchCameraBtn {
    if (_switchCameraBtn == nil) {
        _switchCameraBtn = [[UIButton alloc] init];
        _switchCameraBtn.frame = CGRectMake(300, 44, 30, 30);
